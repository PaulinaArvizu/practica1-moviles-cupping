import 'package:estructura_practica_1/models/product_dessert.dart' as desserts;
...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.POSTRES) {
      ...
      return <desserts.ProductDesserts>[
        desserts.ProductDesserts(
          ...
          productDescription: "Delicioso cheesecake con fruta.",
          productImage:
          ...
          productSize: desserts.ProductSize.M,
          productAmount: 0,
        ),
        desserts.ProductDesserts(
          productTitle: "Pastel de chocolate",
          productDescription: "Pastel de chocolate con relleno suave.",
          productImage:
              "https://www.chocolatehersheys.com/content/dam/chocolatemexico/es_mx/images/recetas/pastel-chocolate.jpg",
          productSize: desserts.ProductSize.M,
          productAmount: 0,
        ),
        desserts.ProductDesserts(
          productTitle: "Pingüino",
          productDescription: "Pingüino Marinela.",
          productImage:
              "https://www.noticias-ahora.com/wp-content/uploads/2018/02/pinguinitos.jpg",
          productSize: desserts.ProductSize.M,
          productAmount: 0,
        ),
        desserts.ProductDesserts(
          productTitle: "Panna Cotta",
          productDescription:
              "Postre italiano elaborado a partir de crema de leche, azúcar y gelificantes, que se suele adornar con mermeladas de frutas rojas.",
          productImage:
        ...
        desserts.ProductDesserts(
          ...
          productDescription:
              "Crema cuya superficie se ha espolvoreado de azúcar con el fin de quemarlo y obtener así una fina capa crujiente de caramelo.",
          productImage:
    ...
    if (prodType == ProductType.BEBIDAS)
      return <hot_drinks.ProductHotDrinks>[
        hot_drinks.ProductHotDrinks(
          ...
          productSize: hot_drinks.ProductSize.M,
          productAmount: 0,
        ),
        hot_drinks.ProductHotDrinks(
